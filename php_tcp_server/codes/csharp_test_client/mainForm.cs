...
namespace csharp_test_client
{
    public partial class mainForm : Form
    {
        ...
        {
            var requestPkt = new LoginReqJsonPacket();
            requestPkt.UserID = textBoxUserID.Text;
            requestPkt.UserPW = textBoxUserPW.Text;
            var bodyData = JsonSerializer.Serialize(requestPkt);


            PostSendPacket(PACKET_ID.REQ_LOGIN, bodyData);            
        ...
        {
            var requestPkt = new RoomEnterReqJsonPacket();
        ...
        private void btnRoomChat_Click(object sender, EventArgs e)
        {
            ...
            var requestPkt = new RoomChatReqJsoPacket();
