...
namespace csharp_test_client
{
    public partial class mainForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            PostSendPacket(CSPacketID.PACKET_ID_ECHO, body);
        ...
        public void PostSendPacket(CSPacketID packetID, byte[] bodyData)
        {
            if (Network.IsConnected() == false)
            {
            ...
            dataSource.AddRange(new byte[3]);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            PostSendPacket(CSPacketID.RequestLogin, loginReq.ToBytes());            
        ...
        private void btn_RoomEnter_Click(object sender, EventArgs e)
        {
            ...
            PostSendPacket(CSPacketID.RequestRoomEnter, requestPkt.ToBytes());
            DevLog.Write($"방 입장 요청:  {textBoxRoomNumber.Text} 번");
        }

        private void btn_RoomLeave_Click(object sender, EventArgs e)
        {
            PostSendPacket(CSPacketID.RequestRoomLeave,  null);
        ...
        private void btnRoomChat_Click(object sender, EventArgs e)
        {
            ...
            var sendPkt = MessagePackSerializer.Serialize(requestPkt);
            MsgPackPacketHeaderInfo.Write(sendPkt, (UInt16)sendPkt.Length, (UInt16)CSPacketID.RequestRoomChat);
            PostSendPacket(sendPkt);

            DevLog.Write($"방 채팅 요청");
        }

        private void textBoxUserPW_TextChanged(object sender, EventArgs e)
        {
