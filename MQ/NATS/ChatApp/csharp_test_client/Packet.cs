...
namespace csharp_test_client
{
    ...
    public class RoomChatNtfPacket
    {
        ...
        {
            var pos = 0;
            var msgLen = BitConverter.ToUInt16(bodyData, pos);
            pos += 2;
            UserID = Encoding.UTF8.GetString(bodyData, pos, msgLen);
            pos += msgLen;

            msgLen = BitConverter.ToUInt16(bodyData, pos);
            pos += 2;
            Message = Encoding.UTF8.GetString(bodyData, pos, msgLen);
            return true;
        }
    }
